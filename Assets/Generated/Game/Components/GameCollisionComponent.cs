...
public partial class GameEntity {
    ...
    public void AddCollision(UnityEngine.GameObject newCollisionSourceObject, UnityEngine.GameObject newCollisionObject) {
    ...
    public void ReplaceCollision(UnityEngine.GameObject newCollisionSourceObject, UnityEngine.GameObject newCollisionObject) {
        var index = GameComponentsLookup.Collision;
        var component = (CollisionComponent)CreateComponent(index, typeof(CollisionComponent));
        component.collisionSourceObject = newCollisionSourceObject;
        component.collisionObject = newCollisionObject;
